...
class AppNome(App):
    ...
    def build(self):
        ...
        box_nome = BoxLayout(orientation="horizontal", size_hint=(1.0, 0.2))
        box_telefone = BoxLayout(orientation="horizontal", size_hint=(1.0, 0.2))

        lbl_nome = Label(text="Nome:", size_hint=(0.3, 1.0))
        lbl_telefone = Label(text="Telefone: ", size_hint=(0.3, 1.0))

        btn_salvar = Button(text="Salvar", size_hint=(1, 1), on_release=self.submit)
